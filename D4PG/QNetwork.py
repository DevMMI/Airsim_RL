...
class QNetwork:
    ...
    def __init__(self, sess, gui, saver, buffer):
        ...
        self.batch_size = tf.shape(self.reward_ph)[0] # the 0th index of the shape operation

        # Support of the distribution
        self.delta_z = (Settings.MAX_Q - Settings.MIN_Q) / (Settings.NB_ATOMS - 1)
        # create the set of atoms that will be the support of the discrete distribution
