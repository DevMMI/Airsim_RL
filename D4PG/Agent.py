...
class Agent:
    ...
    def build_actor(self):
        ...
        self.vars = get_vars(scope, trainable=False) # returns collection of values from scope i.e network weights
    ...
    def build_update(self):
        ...
        with self.sess.as_default(), self.sess.graph.as_default():
            ...
            self.update = copy_vars(self.network_vars, self.vars, # src, dst, update copy actor with most recent weights
